...
const AboutSection = () => {
  return (
    <div className="relative pt-32 sm:pt-48">
        ...
        <div>
          <div className="flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-5">
            <div className="flex items-center gap-2.5">
              <h1 className="text-2xl font-bold sm:text-3xl">Ronit Kedia</h1>
          ...
          <span className="text-muted-foreground mt-1 block text-xs tracking-wide sm:mt-0 sm:text-sm">
            Computer Science Student | Full Stack Developer
          </span>
        </div>

        <p className="text-muted-foreground mt-3 text-sm leading-relaxed font-medium sm:mt-5 sm:text-base dark:text-zinc-300">
          Im a full stack developer who loves building clean, modern websites and apps where
          design, functionality, and even the smallest details matter, with a focus on making
